...
<div class="form_header navbar-spacing">
    ...
    <h2 class="text-center mt-3">Landlord Log In</h2>
    <div class="alert alert-primary mb-4 mt-3 inside-content" role="alert">
        <b>Instructions</b>
        <p class="m-0">Enter a your NIC and a password to login
        </p>
    </div>
    <?php
if (isset($_GET["err"])) {
    ...
    <div class="login-content card-animation">
        <form validate method="post" action="./includes/login.inc.php">
            <div class="from_div_content row g-3 needs-validation">
                <div class="col-md-12">
                    <label for="validationCustom01" class="form-label"><?=required_star()?> NIC / Email</label>
                ...
                <div class="col-md-12 mt-4">
                    <button class="btn btn-primary form-control" style="width: 100%;" type="submit" name="ll_login">
                        Log In
                    </button>
                </div>
